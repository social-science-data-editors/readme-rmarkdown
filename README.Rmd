...
if (rmarkdown::metadata$tutorial) {
  ...
  cat('For additional installation information, see <a href="NOTES.md">NOTES.md</a>.\n')
  cat('</div>\n')
  cat('\n')
}
```
...
cat(sprintf("> %s, %s, \"%s\", %s, https://doi.org/%s",
            cite_authors, cite_date, cite_title, "Borealis, V1", cite_doi))
```
